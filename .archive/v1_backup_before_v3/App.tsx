...
const SERVICES = [
  ...
  },
  {
    ...
    features: [
      "Quick Strike Audits (SMBs, 6-8hr, 90-day plan)", 
      "Enterprise Transformation Audits (Complex orgs, 6-12 month map)", 
...
const EXAMPLES = [
  { title: "Smart Lead Qualification", desc: "Auto-enrich inbound leads and route hot prospects to Slack in real-time.", icon: <Zap className="text-secondary" /> },
  { title: "Content Repurposing Engine", desc: "Turn one video into blog posts, social threads, and email campaigns — automatically.", icon: <Database className="text-primary" /> },
  ...
  { title: "Multi-Platform CRM Sync", desc: "Keep HubSpot, Airtable, Notion, and billing systems perfectly synchronized.", icon: <Settings className="text-white" /> },
  { title: "AI Support Triage", desc: "AI reads support tickets, drafts context-aware replies, and escalates urgent issues instantly.", icon: <MessageSquare className="text-pink-400" /> },
...
const FAQS = [
  ...
  { q: "What types of businesses do you support?", a: "Agencies, consultancies, e-commerce, and service providers doing between £500k - £10M revenue." },
  ...
  { q: "Can you work with our existing tools?", a: "Yes. We specialize in integrating tools you already use like Slack, HubSpot, and Google Workspace." },
  { q: "How long does automation take?", a: "Quick wins take 1-2 weeks. Complex enterprise systems can take 4-8 weeks." },
  { q: "What if my workflows are messy?", a: "That's normal. Part of our 'Consultancy' phase is cleaning and standardizing processes before automating them." },
  { q: "How much does it cost?", a: "Quick audits start at £1k. Custom builds vary based on complexity." },
  { q: "Can you train my team after workflows are built?", a: "Absolutely. We provide Loom video libraries and live handover sessions." },
    ...
    <div className="container mx-auto px-4 relative z-10 text-center">
      ...
      <FadeIn delay={300}>
        <p className="text-xl md:text-2xl text-text-muted max-w-2xl mx-auto mb-12 leading-relaxed font-light">
          FLOWST8 OPERATIONS helps ambitious teams operate faster through <span className="text-white font-medium">AI automation</span>. 
          Stop losing hours to manual work that holds you back.
        </p>
      </FadeIn>
      ...
      <div className="absolute top-1/2 left-4 lg:left-20 hidden xl:block animate-float" style={{ animationDelay: '0s' }}>
        <div className="glass-panel p-5 rounded-2xl flex items-center gap-4 border border-white/10 shadow-2xl">
          <div className="bg-primary/20 p-3 rounded-xl"><Zap className="text-primary w-6 h-6"/></div>
          <div className="text-left">
            <div className="text-xs text-gray-400 uppercase tracking-wider font-semibold">Trigger</div>
            <div className="text-base font-bold text-white">New Lead Received</div>
          </div>
        </div>
      </div>
      <div className="absolute bottom-1/3 right-4 lg:right-20 hidden xl:block animate-float" style={{ animationDelay: '2s' }}>
        <div className="glass-panel p-5 rounded-2xl flex items-center gap-4 border border-white/10 shadow-2xl">
          <div className="bg-secondary/20 p-3 rounded-xl"><Check className="text-secondary w-6 h-6"/></div>
          <div className="text-left">
            <div className="text-xs text-gray-400 uppercase tracking-wider font-semibold">Action</div>
            <div className="text-base font-bold text-white">Contract Sent & Signed</div>
          </div>
        </div>
      </div>
    </div>
      ...
      <main>
        ...
        <section className="py-16 border-b border-white/5 bg-surface/20">
          <div className="container mx-auto px-4 text-center">
            <FadeIn delay={100}>
              <p className="text-text-muted text-sm font-semibold uppercase tracking-widest mb-8">Built for teams who refuse to settle</p>
        ...
        <section className="py-20 bg-background relative">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-12">
              {[
                { h: "Built to Scale, Not Break", p: "We don't patch things together. Every system we build is enterprise-grade, error-handled, and designed to grow with you.", i: <Rocket className="w-6 h-6 text-primary"/> },
                { h: "Tailored to Your Reality", p: "We audit your specific workflows and tech stack to uncover the highest ROI opportunities — no one-size-fits-all templates.", i: <Settings className="w-6 h-6 text-secondary"/> },
                { h: "Sustainable, Not Overwhelming", p: "Eliminate burnout. We build tools that make your team 10x more productive — not 10x busier.", i: <BarChart className="w-6 h-6 text-accent"/> }
              ].map((b, i) => (
        ...
        <section id="examples" className="py-20 bg-surface/30">
          <div className="container mx-auto px-4">
             ...
             <FadeIn delay={300} className="mt-16 text-center">
                ...
                <p className="text-gray-500 font-light">If you can imagine it, we can build it.</p>
             </FadeIn>
          </div>
        </section>
                 ...
                 <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
                    <div>
                      ...
                      <ul className="space-y-6 mb-10">
                        ...
                        <li className="flex items-center text-lg text-gray-200"><div className="mr-4 p-1 rounded-full bg-green-500/20"><Check className="text-green-400 w-4 h-4" /></div> Quantify potential time and cost savings</li>
                        <li className="flex items-center text-lg text-gray-200"><div className="mr-4 p-1 rounded-full bg-green-500/20"><Check className="text-green-400 w-4 h-4" /></div> Uncover opportunities to increase revenue</li>
                      </ul>
